...
public class ApplicationConstants {
    ...
    public static final String ID_FIELD_NOTES = "ID of the resource";
    ...
    public static final String ENABLED_FIELD_NOTES = "Name of the application";
    ...
    public static final String VERSION_FIELD_NOTES = "Version of the resource";
